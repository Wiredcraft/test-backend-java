...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void configureHandlerExceptionResolvers(List<HandlerExceptionResolver> resolvers) {
        resolvers.add((httpServletRequest, httpServletResponse, handler, exception) -> {
            ...
            try {
                ...
                log.error("response write error happened :",e);
            }
    ...
    private FastJsonHttpMessageConverter createFastJsonHttpMessageConverter() {
        ...
        config.setSerializerFeatures(SerializerFeature.WriteMapNullValue, SerializerFeature.DisableCircularReferenceDetect, SerializerFeature.WriteNullNumberAsZero);
